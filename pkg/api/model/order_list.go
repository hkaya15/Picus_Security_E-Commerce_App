...
type OrderList struct {
	...
	// orderitems
	Orderitems []*OrderItemsOrderList `json:"orderitems"`

	// orderprice
	Orderprice int64 `json:"orderprice,omitempty"`

	// userıd
	Userıd string `json:"userıd,omitempty"`
}
...
func (m *OrderList) validateOrderdate(formats strfmt.Registry) error {
...
func (m *OrderList) validateOrderitems(formats strfmt.Registry) error {
...
func (m *OrderList) contextValidateOrderitems(ctx context.Context, formats strfmt.Registry) error {
